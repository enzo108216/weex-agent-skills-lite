...
MESSAGE_TEMPLATES: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "guard.intent_language_mismatch": "确认语言与预览语言不匹配，请重新生成预览。",
    ...
    "en": {
        ...
        "guard.intent_language_mismatch": "The confirmation language does not match the preview. Generate a new preview.",
